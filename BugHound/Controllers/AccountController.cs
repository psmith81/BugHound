...
namespace BugHound.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //[AllowAnonymous]
        // pbs: Changed access to only allow administrator to add new users
        [Authorize(Roles = "Administrator")]
        ...
        [HttpPost]
        //[AllowAnonymous]  // pbs: remove anomymous and make user registration admin function
        [Authorize(Roles = "Administrator")]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //var role = new UserRoleViewModel { RoleName = model.RoleName };

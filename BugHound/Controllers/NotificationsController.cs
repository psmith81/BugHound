...
namespace BugHound.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,TicketId,SentAt,Notification1,Recieved")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,TicketId,SentAt,Notification1,Recieved")] Notification notification)
        {
            if (ModelState.IsValid)
            {
